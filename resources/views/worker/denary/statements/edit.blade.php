            ...
            <form action="{{ route('statement.update',['statement'=>$statement]) }}" method="post"
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <input name="day" class="form-control" value="{{ $statement->day }}" id="validationDefault01"
                               type="number"
                               data-bs-original-title="" title="">
                    </div>
                    <div class="col-md-4">
                        <label class="form-label" for="validationDefault01">Месяц</label>
                        <input name="month" class="form-control" id="validationDefault01"
                    ...
                    <div class="col-md-3">
                        ...
                        <input name="year" class="form-control" id="validationDefault01" value="{{ $statement->year }}"
                               type="number"
                               data-bs-original-title="" title="">
                    </div>
