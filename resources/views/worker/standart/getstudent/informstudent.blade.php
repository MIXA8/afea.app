...
@section('title')
    Информация студента {{ $student->name }} {{ $student->surname }}
@endsection
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form class="needs-validation" novalidate=""
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        <input readonly type="hidden" name="id" value="{{ $student->id }}">
                        <label class="form-label" for="validationCustom01">Фамилия</label>
                        <input readonly class="form-control" id="validationCustom01" name="surname" type="text"
                               placeholder="Фамилия"
                    ...
                    <div class="col-md-4">
                        ...
                        <input readonly class="form-control" id="validationCustom02" name="name" type="text"
                               placeholder="Имя"
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group">
                            <input readonly class="form-control" id="validationCustomUsername" name="patronymic"
                                   type="text"
                ...
                <div class="row g-3">
                    <div class="col-md-2">
                        ...
                        <input readonly class="form-control" id="validationCustom03" name="passport" type="text"
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input readonly class="form-control" id="validationCustom03" name="citizenship" type="text"
                    ...
                    <div class="col-md-3">
                        ...
                        <input readonly class="form-control" id="validationCustom03" name="passport" type="text"
                               value="{{ $student->title->title }}"
                               placeholder="Паспортные данные" required="" data-bs-original-title="" title="">
                    </div>
                    <div class="col-md-3 mb-3">
                        <label class="form-label" for="validationCustom05">ПНФЛ</label>
                        <input readonly class="form-control" id="validationCustom05" type="text" name="PNFL"
                ...
                <div class="row g-3">
                    <div class="col-md-2">
                        ...
                        <input readonly class="form-control" id="validationCustom03" type="date"
                    ...
                    <div class="col-md-3">
                        ...
                        <input readonly class="form-control" id="validationCustom03" type="text"
                               value="{{ $student->family_status }}" name="birthday"
                               data-bs-original-title="" title="">
                    </div>
                    <div class="col-md-3 mb-3">
                        <label class="form-label" for="validationCustom05">Место рождения</label>
                        <input readonly class="form-control" id="validationCustom05" name="place_birthday" type="text"
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input readonly class="form-control" id="validationCustom05" type="text" name="INN"
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input readonly class="form-control" id="validationCustom05" name="n_contract" type="text"
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input readonly class="form-control" id="validationCustom05" name="year_start" type="text"
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input readonly class="form-control" id="validationCustom05" name="year_finish" type="text"
